...
const RESIDENTIAL_DISCOVERY_CSV =
  "confirmAddress,occupancy,condition,timeline,motivation,priceExpectation,mortgageLiens,decisionMakers";

const LAND_DISCOVERY_CSV =
  "parcelLocation,parcelSizeAcreage,landTypeUse,roadAccessUtilities,timeline,motivation,zoningUse,priceExpectation,mortgageLiens,decisionMakers";
...
export const VARIABLE_PRESETS: Preset[] = [
  ...
  preset("INBOUND — Returning All Fresh", "Inbound", {
    ...
    conversation_recency_bucket: "1_7_days",
  }),
  ...
  preset("INBOUND — Returning Some Stale", "Inbound", {
    ...
    decision_makers_status: "fresh",
    decision_makers_value: "sole owner",
    conversation_recency_bucket: "8_30_days",
  }),
  ...
  preset("OUTBOUND — Long Gap", "Outbound", {
    ...
    condition_status: "fresh",
    condition_value: "fair",
    conversation_recency_bucket: "31_90_days",
    greeting_mode: "default",
  }),
